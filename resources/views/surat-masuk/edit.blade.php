                    ...
                    <form action="{{ route('surat-masuk.update', $suratMasuk) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="catatan" id="catatan" rows="2"
                                class="block w-full px-4 py-3 bg-gray-50 border-gray-200 rounded-xl text-sm focus:ring-primary focus:border-primary transition-all">{{ old('catatan', $suratMasuk->catatan) }}</textarea>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="file_lampiran" class="relative cursor-pointer bg-white rounded-md font-bold text-primary hover:text-orange-700 focus-within:outline-none">
                                            <span x-text="fileName ? fileName : 'Upload file baru'">Upload file baru</span>
