                    ...
                    @if($suratKeluar->file_lampiran)
                        <div class="md:col-span-2">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                @endif
                                <a href="{{ Storage::url($suratKeluar->file_lampiran) }}" download class="inline-flex items-center px-4 py-2 bg-primary text-white rounded-lg font-medium hover:bg-orange-600 transition">
